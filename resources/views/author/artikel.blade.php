                    ...
                    <div class="col-8">
                        <div class="card-body d-flex flex-column justify-content-between h-100">
                            ...
                            <div class="mt-1 align-self-end">
                                <form action="{{ route('author.artikel.edit', ['id' => $artikel['id']]) }}" method="GET" class="d-inline">
                                    @csrf
                                    <button class="btn btn-sm btn-primary w-28">Edit</button>
                                </form>
                                <form action="{{ route('author.artikel.delete', ['id' => $artikel['id']]) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus artikel ini?');">
                                    @csrf
