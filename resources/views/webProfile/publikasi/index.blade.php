...
<main class="container show-container">
    ...
    <div class="row">
        ...
        <div class="col-12 d-md-none mb-4">
            @include('webProfile.publikasi._highlight', ['publikasiData' => $publikasiData])
        </div>

        <!-- Konten utama -->
        <div class="col-md-9">
            @include('webProfile.publikasi._list', ['publikasiData' => $publikasiData])
        </div>
    ...
    <div class="text-center mt-3">
        ...
        {{ $publikasiData->links('pagination::bootstrap-5') }}
    </div>
